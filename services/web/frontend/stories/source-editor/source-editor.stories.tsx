...
Once you're familiar with the editor, you can find various project settings in the superPaper menu, accessed via the button in the very top left of the editor. To view tutorials, user guides, and further documentation, please visit our \\href{https://www.superpaper.com/learn}{help library}.

\\section{Some examples to get started}

\\subsection{How to create Sections and Subsections}

Simply use the section and subsection commands, as in this example document! With superPaper, all the formatting and numbering is handled automatically according to the template you've chosen. If you're using Rich Text mode, you can also create new section and subsections via the buttons in the editor toolbar.

\\subsection{How to include Figures}

First you have to upload the image file from your computer using the upload link in the file-tree menu. Then use the includegraphics command to include it in your document. Use the figure environment and the caption command to add a number and a caption to your figure. See the code for Figure \\ref{fig:frog} in this section for an example.

Note that your figure will automatically be placed in the most appropriate place for it, given the surrounding text and taking into account other figures or tables that may be close by. You can find out more about adding images to your documents in this help article on \\href{https://www.superpaper.com/learn/how-to/Including_images_on_superPaper}{including images on superPaper}.
...
Use the table and tabular environments for basic tables --- see Table~\\ref{tab:widgets}, for example. For more information, please see this help article on \\href{https://www.superpaper.com/learn/latex/tables}{tables}.
...
Track changes can be toggled on or off using the option at the top of the Review pane. Track changes allow you to keep track of every change made to the document, along with the person making the change.
...
If however you're using a more general template, such as this one, and would like to alter the margins, a common way to do so is via the geometry package. You can find the geometry package loaded in the preamble at the top of this example file, and if you'd like to learn more about how to adjust the settings, please visit this help article on \\href{https://www.superpaper.com/learn/latex/page_size_and_margins}{page size and margins}.

\\subsection{How to change the document language and spell check settings}

superPaper supports many different languages, including multiple different languages within one document.

To configure the document language, simply edit the option provided to the babel package in the preamble at the top of this example project. To learn more about the different options, please visit this help article on \\href{https://www.superpaper.com/learn/latex/International_language_support}{international language support}.

To change the spell check language, simply open the superPaper menu at the top left of the editor window, scroll down to the spell check setting, and adjust accordingly.

\\subsection{How to add Citations and a References List}

You can simply upload a \\verb|.bib| file containing your BibTeX entries, created with a tool such as JabRef. You can then cite entries from it, like this: \\cite{greenwade93}. Just remember to specify a bibliography style, as well as the filename of the \\verb|.bib|. You can find a \\href{https://www.superpaper.com/help/97-how-to-include-a-bibliography-using-bibtex}{video tutorial here} to learn more about BibTeX.

You can also import a \\verb|.bib| file directly via the upload menu in the file-tree.

\\subsection{Good luck!}

We hope you find superPaper useful, and do take a look at our \\href{https://www.superpaper.com/learn}{help library} for more tutorials and user guides! Please also let us know if you have any feedback using the Contact Us link at the bottom of the superPaper menu --- or use the contact form at \\url{https://www.superpaper.com/contact}.
