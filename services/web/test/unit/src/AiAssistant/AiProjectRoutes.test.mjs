...
describe('AiProject routes', function () {
  it('mounts the project AI config endpoint behind login and project read access', function () {
    const route = findRoute('get', '/project/:Project_id/ai/config')
    ...
    expect(route.handlers).to.include('AiProjectChatController.config')
  })

  it('mounts the project AI chat endpoint behind login, rate limit, and project read access', function () {
    const route = findRoute('post', '/project/:Project_id/ai/chat')
