...
describe('UserUpdater', function () {
  ...
  describe('setDefaultEmailAddress', function () {
    ...
    describe('security alert', function () {
      ...
      it('should send to the most recently (re-)confirmed emails grouped by domain', async function (ctx) {
        setUserEmails(ctx, [
          {
            email: '1@a1.uni',
      ...
      it('should send to the most recently (re-)confirmed emails grouped by multiple domains', async function (ctx) {
        setUserEmails(ctx, [
          {
            email: '1@a1.uni',
            confirmedAt: new Date(2020, 0, 1),
