...
describe('BackFillUsersAnalyticsId', function () {
  ...
  beforeEach('run migration', function (done) {
    exec(
      'cd ../../tools/migrations && yarn run migrations migrate -t server-ce --force 20260424120000_back_fill_users_analyticsId',
      done
    )
  })
  ...
  describe('after rolling back', function () {
    beforeEach(function (done) {
      exec(
        'cd ../../tools/migrations && yarn run migrations rollback -t server-ce --force 20260424120000_back_fill_users_analyticsId',
        done
      )
    })
