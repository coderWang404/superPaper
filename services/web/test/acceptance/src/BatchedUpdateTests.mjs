...
describe('BatchedUpdateTests', function () {
  it('can handle non linear insert order', async function () {
    ...
    spawnSync(process.argv0, [
      '--input-type=module',
      '-e',
      'import { batchedUpdateWithResultHandling } from "@superpaper/mongo-utils/batchedUpdate.js"; import { db } from "./app/src/infrastructure/mongodb.mjs"; batchedUpdateWithResultHandling(db.systemmessages, { content: { $ne: "42" }}, { $set: { content: "42" } })',
    ])
